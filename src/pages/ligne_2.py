...
layout = html.Div([
    ...
    html.Div(
        ...
        children = [
            ...
            html.Div(id='hidden-div-ligne2', style={'display': 'none'}),
...
@callback(
    ...
    Output("shift-input-ligne2", "options"),
    [
...
@callback(
    Output("start-shift-ligne2", "n_clicks"),
    Output("shift-input-ligne2", "value"),
    Output("operateur_mix-input-ligne2", "value"),
    Output("operateur_ensacheus-input-ligne2", "value"),
    Output("clarsite_m-input-ligne2", "value"),
    Output("clarsite_p-input-ligne2", "value"),
    Output("aide_magasinier-input-ligne2", "value"),
    Input("hidden-div-ligne2", "children"),
)
